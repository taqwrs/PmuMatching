...
function openGmailDraft({
  ...
  const subject =
    "นำส่งผลวิเคราะห์การเชื่อมโยงข้อเสนอโครงการวิจัยกับแหล่งทุนภายนอกด้วยระบบ WU-FundConnect";

  const body = [
    "เรียน หัวหน้าโครงการ",
    "",
    "ตามที่สถาบันส่งเสริมการวิจัยและนวัตกรรมสู่ความเป็นเลิศ ได้ใช้ระบบ WU-FundConnect เพื่อวิเคราะห์การเชื่อมโยงข้อเสนอโครงการวิจัยกับแหล่งทุนภายนอกนั้น",
    "",
    ...
    "",
    "https://forms.gle/746jtDWoYRB1dgTZA",
    "",
